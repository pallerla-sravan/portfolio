const Connect = () => {
  return (
    <div className="fixed bottom-8 right-8 animate-slideIn z-20">
      <div className="bg-indigo-600 rounded-lg p-6 shadow-xl">
        ...
        <div className="flex gap-4">
          ...
          <a
            href="https://linkedin.com/in/sravan-pallerla-95604a288/"
            target="_blank"
            rel="noopener noreferrer"
